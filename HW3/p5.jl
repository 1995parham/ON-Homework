...
@constraint(m, [e in E, ie in I[e[1], e[2]]], fz[e[1], e[2], ie[1], ie[2]] >= (z[e[1], e[2], ie[1], ie[2]] - 1) * M + sum(f[i, ie[1], ie[2]] for i = 1:Ds))
@constraint(m, [e in E], sum(f[i, e[1], e[2]] for i = 1:Ds) + sum(fz[e[1], e[2], ie[1], ie[2]] for ie in I[e[1],e[2]]) <= CP[e[1], e[2]])
